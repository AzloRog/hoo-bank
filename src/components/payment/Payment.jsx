                    ...
                    <div className="payment-body">
                        <div className="payment-discount">
                            ...
                            <div className="payment-discount-body">
                                <span className="payment-discount-body-light">20%</span> DISCOUNT FOR 
                                <span className="payment-discount-body-light">1 MONTH</span> ACCOUNT
                            </div>
                        </div>
                        <div className="payment-title">
                            <div className="payment-title-text">
                                The Next<br/> <span>Generation</span><br/> Payment Method.
                            </div>
                            <button className="payment-title-btn">
                                <div className="payment-title-btn-body">
                                    Get<img src={Arrow} /> <br/>Started
                                </div>
                            </button>
                        </div>
